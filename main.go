...
// Функция возвращает строку с количеством урона
...
// возвращает строку - блокировку урона
...
// Функция вовзаращет строку со спец способностями
// обратите внимание на "if else" и на "else"
...
// Возвращает строку - выбор класса персонажа
